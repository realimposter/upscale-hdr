...
echo ""
echo "  1. Create a new GitHub repo in your browser named 'realesrgan-hdr'"
echo "  2. Push this folder to that repo:"
echo "       git remote add origin https://github.com/YOUR_USERNAME/realesrgan-hdr.git"
echo "       git branch -M main"
echo "       git push -u origin main"
echo ""
echo "  3. Go to https://replicate.com/create"
echo "  4. Create model 'realesrgan-hdr'"
